...
- `supabase/migrations/20260502150000_task090_founder_section.sql` — TASK090 : extension CHECK `kind` pour `'founder'`, ajout colonne `milestones jsonb null` sur `compagnie_presentation_sections`, seed row fondateur (ON CONFLICT DO NOTHING). Déclaratif synchronisé : `07c_table_compagnie_presentation.sql`. Appliquée le 2026-05-02.
