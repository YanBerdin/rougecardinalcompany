...
drop view if exists "public"."spectacles_landscape_photos_admin";

drop view if exists "public"."spectacles_landscape_photos_public";

alter table "public"."spectacles" add column "paragraph_2" text;

alter table "public"."spectacles" add column "paragraph_3" text;
