-- Migration: Créer la table home_about_content
-- Source: supabase/schemas/07e_table_home_about.sql (schéma déclaratif)
-- Note: Utiliser create table if not exists pour l'idempotence

create table if not exists public.home_about_content (
