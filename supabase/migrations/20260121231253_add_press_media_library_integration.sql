...
alter table "public"."articles_presse" add column "image_url" text;

alter table "public"."communiques_presse" add column "image_media_id" bigint;

CREATE INDEX idx_communiques_presse_image_media_id ON public.communiques_presse USING btree (image_media_id);

alter table "public"."communiques_presse" add constraint "communiques_presse_image_media_id_fkey" FOREIGN KEY (image_media_id) REFERENCES public.medias(id) ON DELETE SET NULL not valid;

alter table "public"."communiques_presse" validate constraint "communiques_presse_image_media_id_fkey";
