...
- `TASK200` Migrer vers le correctif officiel Sharp / nft de Next.js — **EN COURS 🔄 2026-09-21** — remédiation de 4 vulnérabilités avec Next.js et eslint-config-next `16.3.3`, Sharp `0.35.4` et baseline-browser-mapping `2.11.20`. Audit propre, type-check et 159 tests unitaires réussis ; compilation Next.js réussie, mais hook Sentry post-compilation bloqué localement. Workaround conservé ; validation Vercel après cold start et parcours image encore requis. Voir `memory-bank/tasks/TASK200-migration-correctif-upstream-sharp-nft.md`
