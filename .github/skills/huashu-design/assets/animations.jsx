 ...
 * - Stage: the whole animation container, provides time + controls
 * - Sprite: a time segment, shown between start/end, provides local progress
...
(function() {
  ...
  const Easing = {
    ...
    // Quick start + slow brake — gives digital elements physical weight
