...
export function HeroView({
  ...
  return (
    <section
      ...
      tabIndex={0}
      onKeyDown={onKeyDown}
      className="relative h-svh flex items-center justify-center overflow-hidden select-none outline-none focus-visible:ring-2 focus-visible:ring-gold/60 pb-36 sm:pb-44"
