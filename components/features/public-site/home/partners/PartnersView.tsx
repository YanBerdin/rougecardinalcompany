...
export function PartnersView({ partners, isLoading }: PartnersViewProps) {
    ...
    return (
        <section className="relative z-10 overflow-hidden pt-2 pb-4 sm:pt-6 sm:pb-12 bg-gradient-to-t from-black/80 via-black/60 to-transparent sm:backdrop-blur-sm">
            <LogoCloud
                partners={partners}
