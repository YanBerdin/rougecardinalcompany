...
const newsData: NewsItem[] = [
  {
    ...
    short_description: "Notre spectacle 'Les Murmures du Temps' a été nominé dans la catégorie Meilleur Spectacle d'Auteur Contemporain.",
    date: "2025-08-15",
  ...
  },
  {
    ...
    short_description: "Retrouvez-nous dans 15 villes de France pour une tournée exceptionnelle de nos créations phares.",
    date: "2025-09-10",
  ...
  },
  {
    ...
    short_description: "La compagnie entame une résidence de trois mois au Théâtre de la Ville pour sa prochaine création.",
    date: "2025-12-05",
