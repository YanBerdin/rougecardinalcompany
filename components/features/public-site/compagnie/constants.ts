/**
 * Constants for the Compagnie feature
 * @module components/features/public-site/compagnie/constants
 */

/** Maximum number of values/members to fetch from the DAL */
export const DEFAULT_ITEMS_LIMIT = 12;

/** Animation step delay between items (in seconds) */
