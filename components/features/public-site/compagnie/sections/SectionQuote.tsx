            ...
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-card rounded-2xl p-8">
                    <div className="flex items-start gap-3 sm:gap-4">
                        <Quote className="h-5 w-5 sm:h-7 sm:w-7 text-primary flex-shrink-0 mt-1" aria-hidden="true" />
                        ...
                        <Quote className="h-5 w-5 sm:h-7 sm:w-7 text-primary flex-shrink-0 mt-1 scale-x-[-1]" aria-hidden="true" />
                    </div>
                </div>
