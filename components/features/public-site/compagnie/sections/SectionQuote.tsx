                ...
                <div className="bg-card rounded-2xl p-8">
                    <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <blockquote className="text-md lg:text-lg xl:text-xl italic text-muted-foreground mb-4">
                                {section.quote.text}
                            </blockquote>
                            {section.quote.author && (
                                <cite className="text-gold font-semibold max-sm:text-sm md:text-md lg:text-lg xl:text-xl">{section.quote.author}</cite>
                            )}
                        </div>
