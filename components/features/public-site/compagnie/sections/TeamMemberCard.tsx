                ...
                <div className="space-y-1">
                    ...
                    {hasDescription && (
                        <button
                            ...
                            onClick={() => setOpen(true)}
                            aria-haspopup="dialog"
                            className="text-primary text-xs font-semibold uppercase tracking-widest hover:underline underline-offset-4 mt-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring rounded-sm transition-opacity duration-200"
                        >
                            En savoir plus →
                        </button>
                    )}
