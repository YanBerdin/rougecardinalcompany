...
export function SectionHistory({ section }: SectionRendererProps): ReactElement {
    ...
    return (
        <section id={section.kind} aria-labelledby={headingId} className="py-24 xl:py-32 bg-chart-7">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="animate-fade-in-up">
                        {section.title && (
                            <h2 id={headingId} className="text-3xl md:text-4xl lg:text-6xl italic leading-none tracking-tight mb-6">
                                {section.title}
                            </h2>
                        )}
