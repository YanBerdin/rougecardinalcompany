        ...
        <div className="flex overflow-hidden mb-4 md:mb-6 bg-chart-7">
            <div className="flex gap-6">
                {Array.from({ length: 8 }).map((_, i) => (
                    <div
                        key={i}
                        className="flex items-center justify-center flex-shrink-0 backdrop-blur-sm bg-white/10 dark:bg-black/20 border border-border/30 rounded-xl px-6 py-12 animate-pulse"
