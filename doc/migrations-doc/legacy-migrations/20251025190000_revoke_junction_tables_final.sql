...
-- Ce fichier révoque des privilèges sur des tables applicatives (junction
-- tables et tags). L'exécution a contribué à une panne de production lors
-- de la campagne de révocations. Avant toute ré-exécution, ouvrir un
-- ticket d'impact, obtenir l'accord de l'équipe DBA/SRE et prévoir un
-- plan de restauration des GRANTs. Voir doc/INCIDENT_POSTMORTEM_RLS_GRANTS_2025-10-27.md
--! ==================================================================
