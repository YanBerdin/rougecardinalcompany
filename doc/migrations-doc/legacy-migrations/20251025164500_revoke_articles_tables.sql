...
-- Ce fichier de migration retire des GRANTs (privileges) au niveau des
-- tables (anon/authenticated/PUBLIC). L'exécution a contribué à une
-- interruption de production (panne range 2025-10-26 → 2025-10-27)
-- car PostgreSQL vérifie les GRANTs avant d'appliquer les politiques RLS.
-- Avant toute exécution : consulter doc/INCIDENT_POSTMORTEM_RLS_GRANTS_2025-10-27.md
-- et obtenir l'accord explicite de l'équipe SRE/DBA. Ne pas réappliquer
-- ce type de migration sans ticket, revue et plan de rétablissement.
--! ==================================================================
