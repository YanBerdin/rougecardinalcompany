--! ==================================================================
-- ⚠️  DANGER — RÉVOCATION GLOBALE DES PRIVILEGES
-- Ce script parcourt les objets du schéma et révoque des privilèges pour
-- PUBLIC/anon puis octroie SELECT/EXECUTE à authenticated lorsqu'il est
-- jugé nécessaire. Cette opération est très intrusive et a contribué à
-- une interruption de service en production lors de la campagne de
-- révocations. Ne pas exécuter sans revue d'impact, test en staging,
-- et plan de rollback. Voir doc/INCIDENT_POSTMORTEM_RLS_GRANTS_2025-10-27.md
--! ==================================================================
