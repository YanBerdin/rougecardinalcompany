...
-- Ce fichier cible des tables d'analytics et des fonctions persistantes
-- qui peuvent être recréées par des extensions. Vérifier la nécessité
-- d'ajouter ces objets aux listes blanches/whitelists plutôt que d'enlever
-- les grants manuellement sans coordination. Voir doc/INCIDENT_POSTMORTEM_RLS_GRANTS_2025-10-27.md
--! ==================================================================
