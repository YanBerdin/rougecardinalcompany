--! ==================================================================
-- ⚠️  AVERTISSEMENT — DRY RUN DE RÉVOCATIONS
-- Ce fichier est un dry-run qui propose des REVOKE/GRANT. Même s'il n'exécute
-- pas de commandes, il fait partie d'une série de modifications sensibles.
-- Toute migration dérivée doit être revue et validée par l'équipe DBA/SRE
-- avant d'être appliquée en production. Voir
