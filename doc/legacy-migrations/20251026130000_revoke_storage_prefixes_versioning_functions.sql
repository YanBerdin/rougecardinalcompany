...
-- Ce fichier modifie des objets de stockage et des fonctions d'autorisation
-- (is_admin). Ces changements sont sensibles et nécessitent validation
-- DBA/SRE avant exécution. Voir doc/INCIDENT_POSTMORTEM_RLS_GRANTS_2025-10-27.md
-- ==================================================================
